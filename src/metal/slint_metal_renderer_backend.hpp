...
public:
    ...
    MTL::Texture* currentDrawableTexture() const { return m_currentDrawable; }
    void setExternalDrawable(MTL::Texture* tex) { m_currentDrawable = tex; }
...
private:
    MTL::Texture* m_currentDrawable{nullptr}; // cached drawable texture pointer
};
